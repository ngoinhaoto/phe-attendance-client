      ...
      <DialogContent>
        ...
        <Box sx={{ mb: 2 }}>
          <Typography variant="subtitle1" gutterBottom>
            This table shows attendance status for each student across all sessions.
          </Typography>
        </Box>
            ...
            <Table stickyHeader>
              <TableHead>
                <TableRow>
                  ...
                  {sortedSessions.map(session => (
                    <TableCell key={session.id} align="center" sx={{ minWidth: 100 }}>
              ...
              <TableBody>
                {students.map(student => {
                  ...
                  const rowColor = studentStats.attendanceRate < 70 ? 
                    'rgba(255, 0, 0, 0.05)' : 
                    studentStats.late > 3 ? 
                      'rgba(255, 165, 0, 0.05)' : 
                      'rgba(0, 255, 0, 0.05)';
                  ...
                  return (
                    ...
                    >
                      ...
                      {sortedSessions.map(session => {
                        const attendance = getAttendanceStatus(student.id, session.id);
                        return (
                          <TableCell key={`${student.id}-${session.id}`} align="center">
                            {attendance ? 
                              getStatusChip(attendance.status, attendance.lateMinutes) : 
